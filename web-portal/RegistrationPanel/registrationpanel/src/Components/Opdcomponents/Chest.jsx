  ...
  useEffect(()=>{
    if (tokenType!=null){
      ...
      const subscription = supabase
        .channel("opd_bookings_channel")
        .on(
          "postgres_changes",
          { event: "INSERT", schema: "public", table: "opd_bookings" },
          (payload) => {
      ...
      return () => {
        supabase.removeChannel(subscription); // Cleanup listener
      };
    }
  },[tokenType]);
