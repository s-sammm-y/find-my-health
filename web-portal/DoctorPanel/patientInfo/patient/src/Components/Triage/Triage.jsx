...
const Triage = ()=>{
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('http://localhost:3001/api/triage-list');
    ...
    useEffect(() => {
        ...
        const subscription = supabase
            .channel('triage-list-channel')  // Unique channel name
            .on(
                'postgres_changes', 
                { event: 'INSERT', schema: 'public', table: 'triage' }, 
                () => {
